...
export default function SettingsClientView({
  ...
  const canUseBranding = currentPlan === 'PRO' || currentPlan === 'AI_ENTERPRISE' || isAdmin;

  const handleSubscribe = async (plan: 'STARTER' | 'PRO' | 'AI_ENTERPRISE') => {
    setIsLoading(true);
    try {
                      ...
                      <div className="flex items-center justify-between gap-4 p-2 bg-slate-900 rounded-xl border border-slate-800">
                        <div className="flex items-center gap-3 overflow-hidden">
                          ...
                          <div className="truncate">
                            ...
                            <span className="text-[10px] font-mono text-slate-400 truncate block">{companyLogo}</span>
                          </div>
                        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
              <div>
                ...
                <div className="mt-3 flex items-baseline gap-1">
                  ...
                  <span className="text-xs text-slate-400 font-medium">/ mois (après 14j d&apos;essai)</span>
                </div>
                <p className="text-xs text-brand-400 font-bold mt-1">14 jours d&apos;essai offert sans CB à l&apos;inscription</p>
              ...
              >
                {currentPlan === 'STARTER' ? 'Essai Starter Actif (14j)' : 'Sélectionner Starter (29 €/mois)'}
              </button>
            </div>
            ...
            >
              <div>
                ...
                <p className="text-xs text-emerald-400 font-semibold mt-1">Logo personnalisé + Relances automatiques incluses</p>
              ...
              >
                {currentPlan === 'PRO' ? 'Formule 79€ Active' : 'Passer à Pro (79 €/mois)'}
              </button>
            </div>
            ...
            >
              <div>
                ...
                <p className="text-xs text-indigo-300 font-bold mt-1">Logo d&apos;entreprise + IA de vérification des pièces</p>
              ...
              >
                {currentPlan === 'AI_ENTERPRISE' ? 'Formule IA Active' : 'Activer IA Enterprise (149 €/mois)'}
              </button>
            </div>
          </div>
        </div>
